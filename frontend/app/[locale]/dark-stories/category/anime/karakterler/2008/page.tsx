...
import { ChojiExperience } from "@/components/character/choji-akimichi/ChojiExperience";

/**
 * Chōji Akimichi — AniList #2008.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 2008);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(2008);
  return (
    <ChojiExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
