...
import { NagatoExperience } from "@/components/character/nagato/NagatoExperience";
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 3180);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(3180);
  return (
    <NagatoExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
