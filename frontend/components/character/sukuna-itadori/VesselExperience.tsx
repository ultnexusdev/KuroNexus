...
/**
 * Sukuna & Yuuji Itadori — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`sukuna-itadori-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function VesselExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="sukuna-itadori">
      {portrait ? (
        <Image
          src={portrait}
