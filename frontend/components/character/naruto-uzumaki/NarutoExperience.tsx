...
/**
 * Naruto Uzumaki — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`naruto-uzumaki-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function NarutoExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="naruto-uzumaki">
      {portrait ? (
        <Image
          src={portrait}
