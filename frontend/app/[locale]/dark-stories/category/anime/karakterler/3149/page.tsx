...
import { ObitoExperience } from "@/components/character/obito-uchiha/ObitoExperience";

/**
 * Obito Uchiha — AniList #3149.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 3149);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(3149);
  return (
    <ObitoExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
