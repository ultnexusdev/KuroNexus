...
/**
 * Sasuke Uchiha — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`sasuke-uchiha-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function SasukeExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="sasuke-uchiha">
      {portrait ? (
        <Image
          src={portrait}
