...
/**
 * Rock Lee — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`rock-lee-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function RockLeeExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="rock-lee">
      {portrait ? (
        <Image
          src={portrait}
