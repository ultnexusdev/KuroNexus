...
/**
 * Hinata Hyuuga — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`hinata-hyuuga-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function HinataExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="hinata-hyuuga">
      {portrait ? (
        <Image
          src={portrait}
