...
/**
 * Kisuke Urahara — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`kisuke-urahara-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function UraharaExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="kisuke-urahara">
      {portrait ? (
        <Image
          src={portrait}
