...
/**
 * Kenpachi Zaraki — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`kenpachi-zaraki-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function KenpachiExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="kenpachi-zaraki">
      {portrait ? (
        <Image
          src={portrait}
