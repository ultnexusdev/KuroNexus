...
/**
 * Shikamaru Nara — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`shikamaru-nara-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function ShikamaruExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="shikamaru-nara">
      {portrait ? (
        <Image
          src={portrait}
