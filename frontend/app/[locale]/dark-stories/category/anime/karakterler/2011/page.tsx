...
import { IrukaExperience } from "@/components/character/iruka-umino/IrukaExperience";

/**
 * Iruka Umino — AniList #2011.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 2011);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(2011);
  return (
    <IrukaExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
