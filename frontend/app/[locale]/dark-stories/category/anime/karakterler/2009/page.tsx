...
import { InoExperience } from "@/components/character/ino-yamanaka/InoExperience";

/**
 * Ino Yamanaka — AniList #2009.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 2009);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(2009);
  return (
    <InoExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
