...
/**
 * Kakashi Hatake — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`kakashi-hatake-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function KakashiExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="kakashi-hatake">
      {portrait ? (
        <Image
          src={portrait}
