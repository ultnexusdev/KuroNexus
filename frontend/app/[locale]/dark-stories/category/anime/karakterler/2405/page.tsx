...
import { KabutoExperience } from "@/components/character/kabuto-yakushi/KabutoExperience";

/**
 * Kabuto Yakushi — AniList #2405.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 2405);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(2405);
  return (
    <KabutoExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
