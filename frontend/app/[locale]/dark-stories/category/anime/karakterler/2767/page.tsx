...
import { TsunadeExperience } from "@/components/character/tsunade/TsunadeExperience";

/**
 * Tsunade Senju — AniList #2767.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 2767);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(2767);
  return (
    <TsunadeExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
