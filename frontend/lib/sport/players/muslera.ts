...
export const fernandoMuslera: FavouritePlayer = {
  ...
  nights: [
    ...
    },
    {
      ...
      image: {
        ...
        placeholder: true,
        hint: "Yatay · Uruguay milli takımı · kupa kutlaması · kalabalık kare olabilir, yüz seçilsin",
        width: 1200,
        height: 800,
      },
    },
  ...
  gallery: [
    ...
    },
    {
      ...
      alt: "Uruguay forması",
      placeholder: true,
      hint: "Yatay ya da dikey · milli takım karesi · forma rengini kadrajın merkezine koyma",
      width: 1200,
      height: 800,
      caption: "Uruguay",
    },
