...
/**
 * Sousuke Aizen — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`sousuke-aizen-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function AizenExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="sousuke-aizen">
      {portrait ? (
        <Image
          src={portrait}
