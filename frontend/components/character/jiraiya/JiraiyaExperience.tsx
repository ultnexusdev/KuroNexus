...
/**
 * Jiraiya — deneyim sayfası. **İSKELET SÜRÜM.**
 *
 * Bu dosya 22 Ağustos 2026'da rota dağıtıcısıyla birlikte açıldı ve
 * sayfanın tasarımı ayrı bir dalda (`jiraiya-redesign`) yazılıyor.
 ...
 * bekliyor.
 */
export function JiraiyaExperience({ detail }: CharacterExperienceProps) {
  const portrait = primaryPortrait(detail);
  return (
    <div data-world="jiraiya">
      {portrait ? (
        <Image
          src={portrait}
