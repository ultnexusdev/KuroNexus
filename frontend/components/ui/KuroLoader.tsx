 ...
 * Katmanin rengini `tone` sec iyor, kanji ve halkalar onu miras aliyor.
 * Degerler `globals.css`teki `--loader-*` token'larinda (kural 16).
 */
...
/** Salon kimligi -- `globals.css`teki `--loader-*` token'larina baglaniyor. */
export type KuroLoaderTone = "gold" | "anime";
...
type KuroLoaderProps = {
  ...
  overlay?: boolean;
  /**
   * Katmanin rengi. Varsayilan marka altini; spor salonu da bunu
   * kullaniyor (gorevin karari: "notr altin, degistirme").
   */
  tone?: KuroLoaderTone;
  /**
