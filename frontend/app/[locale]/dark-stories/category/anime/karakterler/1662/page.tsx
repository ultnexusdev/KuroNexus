...
import { GaaraExperience } from "@/components/character/gaara/GaaraExperience";
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 1662);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(1662);
  return (
    <GaaraExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
