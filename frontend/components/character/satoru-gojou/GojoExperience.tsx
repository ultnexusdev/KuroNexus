...
import { EggsSection } from "./EggsSection";
...
export function GojoExperience({ detail, isAdmin }: CharacterExperienceProps) {
  ...
  return (
    <SixEyesProvider fontClassName={GOJO_FONT_CLASS}>
      {/* Keşif durumu sayfa düzeyinde: sekiz keşif beş ayrı bölümde
          tetikleniyor ama TEK kayıtta toplanıyor (P11). */}
      <DiscoveryProvider>
        <CuratorFrame isAdmin={isAdmin}>
          ...
          {/* ══ P11 · KEŞİF KAYDI ═══════════════════════════════════════
            Gerçek keşifler bu bölümde DEĞİL, sayfanın tamamına dağılmış.
            Burası yalnızca kayıt ve kilitli yuvalar ipucu vermiyor. */}
          <section aria-labelledby="gojo-eggs-title">
            <EggsSection locale={locale} />
          </section>
