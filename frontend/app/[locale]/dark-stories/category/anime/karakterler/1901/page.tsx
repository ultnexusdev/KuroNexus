...
import { SaiExperience } from "@/components/character/sai/SaiExperience";
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 1901);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(1901);
  return (
    <SaiExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
