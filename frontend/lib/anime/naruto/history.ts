...
export const NARUTO_ERAS: NarutoEra[] = [
  ...
  },
  {
    ...
    figures: ["Uchiha", "Senju", "Hyūga", "Uzumaki"],
  },
  {
    ...
    figures: ["Hashirama Senju", "Madara Uchiha", "Tobirama"],
  },
  {
    ...
    figures: ["Hiruzen Sarutobi", "Danzō", "Ōnoki"],
  },
  {
  ...
  },
  {
    ...
    figures: ["Minato", "Kushina", "Kurama", "Obito"],
  },
  {
    ...
    figures: ["Itachi", "Sasuke", "Danzō", "Obito"],
  },
  {
    ...
    figures: ["Pain", "Konan", "Obito", "Itachi"],
  },
  {
    ...
    figures: ["Orochimaru", "Hiruzen", "Gaara"],
  },
  {
    ...
    figures: ["Pain", "Naruto", "Tsunade", "Kakashi"],
  },
  {
    ...
    figures: ["Naruto", "Sasuke", "Madara", "Obito", "Kaguya", "Might Guy"],
  },
  {
    name: "Savaş Sonrası",
    desc:
...
export const NARUTO_RANKS: NarutoRank[] = [
  { lvl: "01", name: "AKADEMİ ÖĞRENCİSİ", note: "Henüz göreve çıkmaz", bar: "rgba(232,228,221,.2)" },
  { lvl: "02", name: "GENIN", note: "Üç kişilik takım · bir sensei", bar: "oklch(0.72 0.1 150)" },
  { lvl: "03", name: "CHŪNIN", note: "Takım lideri olabilir", bar: "oklch(0.78 0.11 100)" },
  { lvl: "04", name: "JŌNIN", note: "Sensei · elit görev", bar: "oklch(0.78 0.12 60)" },
  { lvl: "05", name: "ANBU", note: "Kara operasyon · doğrudan Kage'ye bağlı", bar: "oklch(0.66 0.16 28)" },
  { lvl: "06", name: "KAGE", note: "Köyün gölgesi", bar: "#e6b84c" },
];

/** Görev dereceleri */
export const NARUTO_MISSIONS: NarutoMission[] = [
  { letter: "D", desc: "Angarya · düşük risk", bar: "rgba(232,228,221,.2)" },
  { letter: "C", desc: "Küçük çatışma riski", bar: "oklch(0.74 0.1 150)" },
  { letter: "B", desc: "Shinobi'ye karşı", bar: "oklch(0.78 0.11 100)" },
  { letter: "A", desc: "Kritik · elit hedef", bar: "oklch(0.78 0.12 55)" },
  { letter: "S", desc: "Suikast · devlet sırrı", bar: "oklch(0.64 0.18 28)" },
];
