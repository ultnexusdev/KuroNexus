...
import { VolcanoExperience } from "@/components/character/jougo/VolcanoExperience";

/**
 * Jōgo — AniList #156991 (Jujutsu Kaisen).
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 156991);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(156991);
  return (
    <VolcanoExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
