...
import { MadaraExperience } from "@/components/character/madara-uchiha/MadaraExperience";

/**
 * Madara Uchiha — AniList #53901.
 *
...
export async function generateMetadata({
  ...
  return experienceMetadata(locale, 53901);
}

export default async function Page() {
  const { detail, isAdmin, companions } = await loadExperiencePage(53901);
  return (
    <MadaraExperience detail={detail} isAdmin={isAdmin} companions={companions} />
  );
}
